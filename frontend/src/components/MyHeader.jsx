...
function MyHeader() {
    ...
    <>
        <header className={` ${isNavOpen ? 'is-opened-header' : ''}`}> 
            ...
            <div className={`tablet-menu ${isNavOpen ? 'is-opened' : ''}`} id='tablet-menu'>
              <CategoryWidget closeNav={closeNav} ></CategoryWidget>    
            </div>
            <div className={`cart-menu ${isCartOpen ? 'is-opened' : ''}`}>
                <Cart></Cart>
            </div>    
            <div onClick={toggleNav} className={`grey-background ${isNavOpen ? 'is-opened' : ''}`} id='grey-background'> </div>
            <div  onClick={toggleCart} className={`grey-background ${isCartOpen ? 'is-opened' : ''}`} id='grey-background'></div>
